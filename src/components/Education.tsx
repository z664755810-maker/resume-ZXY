  ...
  return (
    <section className="bg-white rounded-2xl p-6 card-shadow">
      <div className="section-title">
        <div className="icon-box bg-gradient-to-br from-green-500 to-green-600">
      ...
      <div className="relative">
        ...
        <div className="relative pl-16">
          ...
          <div className="bg-gray-50 rounded-xl p-5 hover:bg-green-50/50 transition-colors duration-300 border border-gray-100">
