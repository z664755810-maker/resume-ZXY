    ...
    >
      <div className="flex flex-col md:flex-row items-center gap-6">
        <div className="relative shrink-0">
          ...
          <div
            className="absolute -bottom-2 -right-2 bg-green-500 text-white text-xs font-bold px-2.5 rounded-full flex items-center justify-center"
            style={{ height: '22px', lineHeight: '1' }}
          >
            <span className="w-1.5 h-1.5 bg-white rounded-full mr-1 inline-block"></span>
            <span style={{ lineHeight: '1' }}>大三在读</span>
          </div>
        </div>
