...
const projects = [
  ...
  },
  {
    ...
    highlights: [
      ...
      '深入实践Prompt Engineering：为不同角色设计针对性的提示词策略，包括角色扮演法、思维链（Chain of Thought）、Few-shot示例等，显著提升AI回复的专业性与准确性',
      '实现AI辅助数据分析：通过自然语言查询自动生成SQL语句、解读销售趋势、提供库存预警建议，将业务人员的数据分析效率提升3倍',
      '为所有数据库操作添加事务管理与异常捕获，数据操作成功率99.9%',
      '全程使用ChatGPT/Claude/Kimi等AI工具辅助开发，从需求分析、技术方案设计到代码生成与调试，将开发周期缩短约40%'
    ]
  }
];
